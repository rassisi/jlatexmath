...
public class FooPackage {
	...
	public class MyAtom extends Atom {
		...
		public Box createBox(TeXEnvironment env) {
			return new MyBox(null, (int) f, new SpaceAtom(TeXConstants.UNIT_POINT, f, 0, 0).createBox(env).getWidth(),
					filled);
		}

		@Override
		protected Box doCreateBox(TeXEnvironment env) {
	...
	public class MyBox extends Box {
		...
		public MyBox(Atom atom, int r, float f, boolean filled) {
			super(atom);
			this.r = r;
			this.filled = filled;
			this.width = f;
