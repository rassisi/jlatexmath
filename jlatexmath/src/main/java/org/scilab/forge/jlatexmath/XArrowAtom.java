...
public class XArrowAtom extends Atom {
	...
	public Box doCreateBox(TeXEnvironment env) {
		Box O = over != null ? over.createBox(env.supStyle()) : new StrutBox(this, 0, 0, 0, 0);
		Box U = under != null ? under.createBox(env.subStyle()) : new StrutBox(this, 0, 0, 0, 0);
		...
		Box ohb = new HorizontalBox(this, O, width, TeXConstants.ALIGN_CENTER);
		Box uhb = new HorizontalBox(this, U, width, TeXConstants.ALIGN_CENTER);
		...
		HorizontalBox hb = new HorizontalBox(this, vb, vb.getWidth() + 2 * sep.getHeight(), TeXConstants.ALIGN_CENTER);
		return hb;
	}
}
