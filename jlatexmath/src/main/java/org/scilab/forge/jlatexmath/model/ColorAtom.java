...
public class ColorAtom extends Atom implements Row {
	...
	/**
	 * Creates a new ColorAtom that sets the given colors for the given atom. Null
	 * for a color means: no specific color set for this atom.
	 *
	...
	/**
	 * Creates a ColorAtom that overrides the colors of the given ColorAtom if the
	 * given colors are not null. If they're null, the old values are used.
	 *
	 * @param bg  the background color
	 * @param c   the foreground color
	 * @param old the ColorAtom for which the colorsettings should be overriden with
	 *            the given colors.
	 */
