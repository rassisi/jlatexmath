...
public class HorizontalRule extends Box {
	...
	public HorizontalRule(Atom atom, float thickness, float width, float s) {
		super(atom);
		height = thickness;
		this.width = width;
		shift = s;
	...
	public HorizontalRule(Atom atom, float thickness, float width, float s, boolean trueShift) {
		super(atom);
		height = thickness;
		this.width = width;
		if (trueShift) {
	...
	public HorizontalRule(Atom atom, float thickness, float width, float s, Color c) {
		super(atom);
		height = thickness;
		this.width = width;
		color = c;
