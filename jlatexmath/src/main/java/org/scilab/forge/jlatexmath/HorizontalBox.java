...
public class HorizontalBox extends Box {
	...
	public HorizontalBox(Atom atom, Box b) {
		super(atom);
		add(b);
	}

	public HorizontalBox(Atom atom) {
		// basic horizontal box
		super(atom);
	}

	public HorizontalBox(Atom atom, Color fg, Color bg) {
		super(atom, fg, bg);
	}

	public HorizontalBox cloneBox() {
		HorizontalBox b = new HorizontalBox(getAtom(), foreground, background);
		b.shift = shift;
