...
public class NthRoot extends Atom {
	...
	public Box doCreateBox(TeXEnvironment env) {
		...
		HorizontalBox b = new HorizontalBox(this, bs);
		...
		HorizontalBox squareRoot = new HorizontalBox(this, rootSign);
		squareRoot.add(ob);
		...
		if (root == null)
			...
			Box res = new HorizontalBox(this);
			float pos = r.getWidth() + negativeKern.getWidth();
			if (pos < 0)
				res.add(new StrutBox(this, -pos, 0, 0, 0));
