...
import org.scilab.forge.jlatexmath.model.AccentedAtom;
import org.scilab.forge.jlatexmath.model.Atom;
import org.scilab.forge.jlatexmath.model.BigDelimiterAtom;
import org.scilab.forge.jlatexmath.model.BoldAtom;
import org.scilab.forge.jlatexmath.model.BreakMarkAtom;
import org.scilab.forge.jlatexmath.model.CedillaAtom;
...
import org.scilab.forge.jlatexmath.model.DdotsAtom;
import org.scilab.forge.jlatexmath.model.DoubleFramedAtom;
import org.scilab.forge.jlatexmath.model.FBoxAtom;
import org.scilab.forge.jlatexmath.model.FcscoreAtom;
import org.scilab.forge.jlatexmath.model.FencedAtom;
import org.scilab.forge.jlatexmath.model.FractionAtom;
import org.scilab.forge.jlatexmath.model.GeoGebraLogoAtom;
import org.scilab.forge.jlatexmath.model.GraphicsAtom;
import org.scilab.forge.jlatexmath.model.HdotsforAtom;
import org.scilab.forge.jlatexmath.model.HlineAtom;
import org.scilab.forge.jlatexmath.model.IJAtom;
import org.scilab.forge.jlatexmath.model.IddotsAtom;
import org.scilab.forge.jlatexmath.model.ItAtom;
import org.scilab.forge.jlatexmath.model.JavaFontRenderingAtom;
import org.scilab.forge.jlatexmath.model.LCaronAtom;
import org.scilab.forge.jlatexmath.model.LaTeXAtom;
import org.scilab.forge.jlatexmath.model.LapedAtom;
import org.scilab.forge.jlatexmath.model.LongdivAtom;
...
import org.scilab.forge.jlatexmath.model.MonoScaleAtom;
import org.scilab.forge.jlatexmath.model.MulticolumnAtom;
import org.scilab.forge.jlatexmath.model.MultlineAtom;
import org.scilab.forge.jlatexmath.model.OgonekAtom;
import org.scilab.forge.jlatexmath.model.OvalAtom;
import org.scilab.forge.jlatexmath.model.OverlinedAtom;
import org.scilab.forge.jlatexmath.model.PhantomAtom;
import org.scilab.forge.jlatexmath.model.RaiseAtom;
import org.scilab.forge.jlatexmath.model.ReflectAtom;
import org.scilab.forge.jlatexmath.model.ResizeAtom;
import org.scilab.forge.jlatexmath.model.RomanAtom;
import org.scilab.forge.jlatexmath.model.RotateAtom;
import org.scilab.forge.jlatexmath.model.RowAtom;
import org.scilab.forge.jlatexmath.model.RuleAtom;
import org.scilab.forge.jlatexmath.model.ScaleAtom;
import org.scilab.forge.jlatexmath.model.ScriptsAtom;
import org.scilab.forge.jlatexmath.model.ShadowAtom;
import org.scilab.forge.jlatexmath.model.SmallCapAtom;
import org.scilab.forge.jlatexmath.model.SmashedAtom;
import org.scilab.forge.jlatexmath.model.SpaceAtom;
import org.scilab.forge.jlatexmath.model.SsAtom;
import org.scilab.forge.jlatexmath.model.StrikeThroughAtom;
import org.scilab.forge.jlatexmath.model.StyleAtom;
import org.scilab.forge.jlatexmath.model.SymbolAtom;
import org.scilab.forge.jlatexmath.model.TStrokeAtom;
import org.scilab.forge.jlatexmath.model.TextCircledAtom;
import org.scilab.forge.jlatexmath.model.TextStyleAtom;
import org.scilab.forge.jlatexmath.model.TtAtom;
import org.scilab.forge.jlatexmath.model.TypedAtom;
import org.scilab.forge.jlatexmath.model.UnderOverArrowAtom;
import org.scilab.forge.jlatexmath.model.UnderOverAtom;
import org.scilab.forge.jlatexmath.model.UnderlinedAtom;
...
import org.scilab.forge.jlatexmath.model.VdotsAtom;
import org.scilab.forge.jlatexmath.model.XArrowAtom;
import org.scilab.forge.jlatexmath.model.tcaronAtom;
import org.scilab.forge.jlatexmath.ui.JavaFontRenderingBox;
...
public class PredefMacros {
	...
	public static final Atom choose_brackets(final String left, final String right, final TeXParser tp,
		...
		return new FencedAtom(new FractionAtom(num, denom, false),
				new SymbolAtom(left, TeXConstants.TYPE_OPENING, true),
				new SymbolAtom(right, TeXConstants.TYPE_CLOSING, true));
	}
	...
	public static final Atom binom_macro(final TeXParser tp, final String[] args) throws ParseException {
		...
		return new FencedAtom(new FractionAtom(num.root, denom.root, false),
	...
	public static final Atom prescript_macro(final TeXParser tp, final String[] args) throws ParseException {
		...
		tp.addAtom(new ScriptsAtom(new PhantomAtom(base, false, true, true), new TeXFormula(tp, args[2]).root,
				new TeXFormula(tp, args[1]).root, false));
	...
	public static final Atom underbrace_macro(final TeXParser tp, final String[] args) throws ParseException {
		return new OverUnderDelimiter(new TeXFormula(tp, args[1], false).root, null, SymbolAtom.get("rbrace"),
	...
	public static final Atom overbrace_macro(final TeXParser tp, final String[] args) throws ParseException {
		return new OverUnderDelimiter(new TeXFormula(tp, args[1], false).root, null, SymbolAtom.get("lbrace"),
	...
	public static final Atom underbrack_macro(final TeXParser tp, final String[] args) throws ParseException {
		return new OverUnderDelimiter(new TeXFormula(tp, args[1], false).root, null, SymbolAtom.get("rsqbrack"),
				TeXConstants.UNIT_EX, 0, false);
	}

	public static final Atom overbrack_macro(final TeXParser tp, final String[] args) throws ParseException {
		return new OverUnderDelimiter(new TeXFormula(tp, args[1], false).root, null, SymbolAtom.get("lsqbrack"),
				TeXConstants.UNIT_EX, 0, true);
	}

	public static final Atom underparen_macro(final TeXParser tp, final String[] args) throws ParseException {
		return new OverUnderDelimiter(new TeXFormula(tp, args[1], false).root, null, SymbolAtom.get("rbrack"),
				TeXConstants.UNIT_EX, 0, false);
	}

	public static final Atom overparen_macro(final TeXParser tp, final String[] args) throws ParseException {
		return new OverUnderDelimiter(new TeXFormula(tp, args[1], false).root, null, SymbolAtom.get("lbrack"),
				TeXConstants.UNIT_EX, 0, true);
	}
	...
	public static final Atom mathpunct_macro(final TeXParser tp, final String[] args) throws ParseException {
		return new TypedAtom(TeXConstants.TYPE_PUNCTUATION, TeXConstants.TYPE_PUNCTUATION,
				new TeXFormula(tp, args[1], false).root);
	}

	public static final Atom mathord_macro(final TeXParser tp, final String[] args) throws ParseException {
		return new TypedAtom(TeXConstants.TYPE_ORDINARY, TeXConstants.TYPE_ORDINARY,
				new TeXFormula(tp, args[1], false).root);
	}

	public static final Atom mathrel_macro(final TeXParser tp, final String[] args) throws ParseException {
		return new TypedAtom(TeXConstants.TYPE_RELATION, TeXConstants.TYPE_RELATION,
				new TeXFormula(tp, args[1], false).root);
	}
	...
	public static final Atom cr_macro(final TeXParser tp, final String[] args) throws ParseException {
		if (tp.isArrayMode()) {
			...
			tp.finish();
			tp.formula.root = array.getAsVRow();// new MatrixAtom(tp.getIsPartial(), array, MatrixAtom.ARRAY,
												// TeXConstants.ALIGN_LEFT, false);
		}
	...
	public static final Atom smallmatrixATATenv_macro(final TeXParser tp, final String[] args) throws ParseException {
		ArrayOfAtoms array = new ArrayOfAtoms();
	...
	public static final Atom matrixATATenv_macro(final TeXParser tp, final String[] args) throws ParseException {
		ArrayOfAtoms array = new ArrayOfAtoms();
		TeXParser parser = new TeXParser(tp.getIsPartial(), args[1], array, false);
		parser.parse();
		array.checkDimensions();
	...
	public static final Atom arrayATATenv_macro(final TeXParser tp, final String[] args) throws ParseException {
		ArrayOfAtoms array = new ArrayOfAtoms();
	...
	public static final Atom flalignATATenv_macro(final TeXParser tp, final String[] args) throws ParseException {
		ArrayOfAtoms array = new ArrayOfAtoms();
		TeXParser parser = new TeXParser(tp.getIsPartial(), args[1], array, false);
		parser.parse();
		array.checkDimensions();
	...
	public static final Atom alignatATATenv_macro(final TeXParser tp, final String[] args) throws ParseException {
		ArrayOfAtoms array = new ArrayOfAtoms();
		TeXParser parser = new TeXParser(tp.getIsPartial(), args[2], array, false);
		parser.parse();
		array.checkDimensions();
	...
	public static final Atom alignedATATenv_macro(final TeXParser tp, final String[] args) throws ParseException {
		ArrayOfAtoms array = new ArrayOfAtoms();
		TeXParser parser = new TeXParser(tp.getIsPartial(), args[1], array, false);
		parser.parse();
		array.checkDimensions();
	...
	public static final Atom alignedatATATenv_macro(final TeXParser tp, final String[] args) throws ParseException {
		ArrayOfAtoms array = new ArrayOfAtoms();
		TeXParser parser = new TeXParser(tp.getIsPartial(), args[2], array, false);
		parser.parse();
		array.checkDimensions();
	...
	public static final Atom multlineATATenv_macro(final TeXParser tp, final String[] args) throws ParseException {
		ArrayOfAtoms array = new ArrayOfAtoms();
		TeXParser parser = new TeXParser(tp.getIsPartial(), args[1], array, false);
		parser.parse();
		array.checkDimensions();
	...
	public static final Atom gatherATATenv_macro(final TeXParser tp, final String[] args) throws ParseException {
		ArrayOfAtoms array = new ArrayOfAtoms();
		TeXParser parser = new TeXParser(tp.getIsPartial(), args[1], array, false);
		parser.parse();
		array.checkDimensions();
	...
	public static final Atom gatheredATATenv_macro(final TeXParser tp, final String[] args) throws ParseException {
		ArrayOfAtoms array = new ArrayOfAtoms();
		TeXParser parser = new TeXParser(tp.getIsPartial(), args[1], array, false);
		parser.parse();
		array.checkDimensions();
	...
	public static final Atom makeatletter_macro(final TeXParser tp, final String[] args) throws ParseException {
		tp.makeAtLetter();
		return null;
	}
	...
	public static final Atom questeq_macro(final TeXParser tp, final String[] args) throws ParseException {
		Atom at = new UnderOverAtom(SymbolAtom.get(TeXFormula.symbolMappings['=']),
				new ScaleAtom(SymbolAtom.get(TeXFormula.symbolMappings['?']), 0.75f), TeXConstants.UNIT_MU, 2.5f, true,
				true);
	...
	public static final Atom stackrel_macro(final TeXParser tp, final String[] args) throws ParseException {
		Atom at = new UnderOverAtom(new TeXFormula(tp, args[2], false).root, new TeXFormula(tp, args[3], false).root,
				TeXConstants.UNIT_MU, 0.5f, true, new TeXFormula(tp, args[1], false).root, TeXConstants.UNIT_MU, 2.5f,
				true);
		return new TypedAtom(TeXConstants.TYPE_RELATION, TeXConstants.TYPE_RELATION, at);
	}
	...
	public static final Atom overset_macro(final TeXParser tp, final String[] args) throws ParseException {
		Atom at = new UnderOverAtom(new TeXFormula(tp, args[2], false).root, new TeXFormula(tp, args[1], false).root,
				TeXConstants.UNIT_MU, 2.5f, true, true);
		return new TypedAtom(TeXConstants.TYPE_RELATION, TeXConstants.TYPE_RELATION, at);
	}

	public static final Atom underset_macro(final TeXParser tp, final String[] args) throws ParseException {
		Atom at = new UnderOverAtom(new TeXFormula(tp, args[2], false).root, new TeXFormula(tp, args[1], false).root,
				TeXConstants.UNIT_MU, 0.5f, true, false);
		return new TypedAtom(TeXConstants.TYPE_RELATION, TeXConstants.TYPE_RELATION, at);
	}
	...
	public static final Atom underaccent_macro(final TeXParser tp, final String[] args) throws ParseException {
		return new UnderOverAtom(new TeXFormula(tp, args[2], false).root, new TeXFormula(tp, args[1], false).root,
	...
	public static final Atom rotatebox_macro(final TeXParser tp, final String[] args) throws ParseException {
		return new RotateAtom(new TeXFormula(tp, args[2]).root, args[1] == null ? 0 : Double.parseDouble(args[1]),
				args[3]);
	}
	...
	public static final Atom resizebox_macro(final TeXParser tp, final String[] args) throws ParseException {
		return new ResizeAtom(new TeXFormula(tp, args[3]).root, args[1], args[2],
	...
	public static final Atom raisebox_macro(final TeXParser tp, final String[] args) throws ParseException {
		...
		return new RaiseAtom(new TeXFormula(tp, args[2]).root, (int) raise[0], raise[1], (int) height[0], height[1],
				(int) depth[0], depth[1]);
	}
	...
	public static final Atom doteq_macro(final TeXParser tp, final String[] args) throws ParseException {
		Atom at = new UnderOverAtom(SymbolAtom.get("equals"), SymbolAtom.get("ldotp"), TeXConstants.UNIT_MU, 3.7f,
				false, true);
		return new TypedAtom(TeXConstants.TYPE_RELATION, TeXConstants.TYPE_RELATION, at);
	}
	...
	public static final Atom jlmExternalFont_macro(final TeXParser tp, final String[] args) throws ParseException {
	...
	public static final Atom DeclareMathSizes_macro(final TeXParser tp, final String[] args) throws ParseException {
		DefaultTeXFont.setMathSizes(Float.parseFloat(args[1]), Float.parseFloat(args[2]), Float.parseFloat(args[3]),
				Float.parseFloat(args[4]));
		return null;
	}

	public static final Atom magnification_macro(final TeXParser tp, final String[] args) throws ParseException {
	...
	public static final Atom size_macros(final TeXParser tp, final String[] args) throws ParseException {
		...
		return new MonoScaleAtom(new TeXFormula(tp, tp.getOverArgument(), null, false, tp.isIgnoreWhiteSpace()).root,
				f);
	}
	...
	public static final Atom dotminus_macro(final TeXParser tp, final String[] args) throws ParseException {
		Atom at = new UnderOverAtom(SymbolAtom.get("minus"), SymbolAtom.get("normaldot"), TeXConstants.UNIT_MU, -3.3f,
				false, true);
		return new TypedAtom(TeXConstants.TYPE_BINARY_OPERATOR, TeXConstants.TYPE_BINARY_OPERATOR, at);
	}

	public static final Atom ratio_macro(final TeXParser tp, final String[] args) throws ParseException {
		Atom at = new UnderOverAtom(SymbolAtom.get("normaldot"), SymbolAtom.get("normaldot"), TeXConstants.UNIT_MU,
				5.2f, false, true);
		return new TypedAtom(TeXConstants.TYPE_RELATION, TeXConstants.TYPE_RELATION, at);
	}
	...
	public static final Atom minuscolon_macro(final TeXParser tp, final String[] args) throws ParseException {
		...
		at.add(new UnderOverAtom(SymbolAtom.get("normaldot"), SymbolAtom.get("normaldot"), TeXConstants.UNIT_MU, 5.2f,
				false, true));
		return new TypedAtom(TeXConstants.TYPE_RELATION, TeXConstants.TYPE_RELATION, at);
	}
	...
	public static final Atom minuscoloncolon_macro(final TeXParser tp, final String[] args) throws ParseException {
		RowAtom at = new RowAtom(SymbolAtom.get("minus"));
		at.add(new SpaceAtom(TeXConstants.UNIT_EM, -0.095f, 0f, 0f));
		Atom colon = new UnderOverAtom(SymbolAtom.get("normaldot"), SymbolAtom.get("normaldot"), TeXConstants.UNIT_MU,
				5.2f, false, true);
		at.add(colon);
		at.add(colon);
		return new TypedAtom(TeXConstants.TYPE_RELATION, TeXConstants.TYPE_RELATION, at);
	...
	public static final Atom coloncolonminus_macro(final TeXParser tp, final String[] args) throws ParseException {
		Atom colon = new UnderOverAtom(SymbolAtom.get("normaldot"), SymbolAtom.get("normaldot"), TeXConstants.UNIT_MU,
				5.2f, false, true);
	...
	public static final Atom coloncolonequals_macro(final TeXParser tp, final String[] args) throws ParseException {
		Atom colon = new UnderOverAtom(SymbolAtom.get("normaldot"), SymbolAtom.get("normaldot"), TeXConstants.UNIT_MU,
				5.2f, false, true);
		RowAtom at = new RowAtom(colon);
		at.add(colon);
	...
	public static final Atom coloncolonsim_macro(final TeXParser tp, final String[] args) throws ParseException {
		Atom colon = new UnderOverAtom(SymbolAtom.get("normaldot"), SymbolAtom.get("normaldot"), TeXConstants.UNIT_MU,
				5.2f, false, true);
		RowAtom at = new RowAtom(colon);
		at.add(colon);
	...
	public static final Atom coloncolonapprox_macro(final TeXParser tp, final String[] args) throws ParseException {
		Atom colon = new UnderOverAtom(SymbolAtom.get("normaldot"), SymbolAtom.get("normaldot"), TeXConstants.UNIT_MU,
				5.2f, false, true);
		RowAtom at = new RowAtom(colon);
		at.add(colon);
	...
	public static final Atom smallfrowneq_macro(final TeXParser tp, final String[] args) throws ParseException {
		Atom at = new UnderOverAtom(SymbolAtom.get("equals"), SymbolAtom.get("smallfrown"), TeXConstants.UNIT_MU, -2f,
				true, true);
		return new TypedAtom(TeXConstants.TYPE_RELATION, TeXConstants.TYPE_RELATION, at);
	}
