...
public class LaTeXAtom extends Atom {
	...
	public Box doCreateBox(TeXEnvironment env) {
		...
		HorizontalBox hb = new HorizontalBox(this, rat.getLastAtom().createBox(env));
		...
		CharBox A = new CharBox(this, env.getTeXFont().getChar('A', "mathnormal", env.supStyle().getStyle()));
		A.setShift(-f);
		hb.add(A);
