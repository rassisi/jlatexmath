...
public class LCaronAtom extends Atom {
	...
	public Box doCreateBox(TeXEnvironment env) {
		CharBox A = new CharBox(this, env.getTeXFont().getChar("textapos", env.getStyle()));
		CharBox L = new CharBox(this, env.getTeXFont().getChar(upper ? 'L' : 'l', "mathnormal", env.getStyle()));
		HorizontalBox hb = new HorizontalBox(this, L);
		if (upper)
