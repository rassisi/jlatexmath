...
public class ShadowBox extends FramedBox {
	...
	public ShadowBox(Atom atom, FramedBox fbox, float shadowRule) {
	...
	public void draw(Graphics2D g2, float x, float y) {
		...
		g2.draw(new Rectangle2D.Float(x + th, y - height + th, width - shadowRule - thickness,
		...
		g2.fill(new Rectangle2D.Float(x + shadowRule - penth, y + depth - shadowRule - penth, width - shadowRule,
				shadowRule));
		g2.fill(new Rectangle2D.Float(x + width - shadowRule - penth, y - height + th + shadowRule, shadowRule,
